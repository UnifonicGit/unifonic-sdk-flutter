...
@ConfigurePigeon(PigeonOptions(
  dartOut:
      '../unifonic_sdk_flutter_platform_interface/lib/src/models/unifonic_sdk_api.dart',
  dartTestOut:
      '../unifonic_sdk_flutter_platform_interface/test/unifonic_sdk_api_test.dart',
  // for iOS (not macOS, because Pigeon only supports 1 output path per language)
  // swiftOptions: SwiftOptions(),
  // swiftOut: '../unifonic_sdk_flutter_ios/ios/Classes/models/UnifonicSdkApiPush.swift',
  objcHeaderOut:
      '../unifonic_sdk_flutter_ios/ios/Classes/models/UnifonicSdkApiPush.h',
  objcSourceOut:
      '../unifonic_sdk_flutter_ios/ios/Classes/models/UnifonicSdkApiPush.m',
