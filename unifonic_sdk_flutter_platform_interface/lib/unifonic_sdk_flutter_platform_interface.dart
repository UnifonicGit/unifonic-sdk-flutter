...
import 'package:unifonic_sdk_flutter_platform_interface/src/models/unifonic_sdk_api.dart';

export 'src/models/unifonic_sdk_api.dart'
    show
        RemoteMessage,
        Notification,
...
class UnifonicPush extends PlatformInterface {
  UnifonicPush() : super(token: _token) {
  ...
  static UnifonicPush _instance = UnifonicPush();

  /// The default instance of [UnifonicPush] to use.
  ///
  /// Defaults to [UnifonicPush] implemented in `unifonic_sdk_flutter_platform_interface`.
  ...
  /// register themselves.
  static set instance(UnifonicPush instance) {
...
class PushFlutterHandlers extends PushFlutterApi {
  ...
  void onNotificationTap(Map<String?, Object?> data) {
    push._onNotificationTapStreamController.add(data);
  }
